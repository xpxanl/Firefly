...
>
> [![Stars](https://img.shields.io/github/stars/CuteLeafawacg?style=social)](https://github.com/CuteLeafawacg/stargazers)
[![Forks](https://img.shields.io/github/forks/CuteLeafawacg?style=social)](https://github.com/CuteLeafawacg/network/members)
[![Issues](https://img.shields.io/github/issues/CuteLeafawacg)](https://github.com/CuteLeafawacg/issues)
> 
> [![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/Z8Z41NQALY)
>
> **QQ交流群：[1087127207](https://)**
> 
> ![GitHub License](https://img.shields.io/github/license/CuteLeafawacg)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/CuteLeafawacg)
...
🚀 クイックガイド：
[**🖥️ライブデモ**](https://awacg.cuteleaf.cn/) /
[**📝ドキュメント**](https://docs-awacg.cuteleaf.cn/) /
...
>[!TIP]
>
awacg は、Astro フレームワークと Fuwari テンプレートをベースに開発された、清新で美しくモダンな個人ブログテーマテンプレートです。技術愛好家やコンテンツクリエイター向けに設計されており、モダンな Web 技術スタックを統合し、豊富な機能モジュールと高いカスタマイズ性を備えたインターフェースで、プロフェッショナルで美しい個人ブログを手軽に構築できます。
>
>主要なレイアウト面では、awacg は左右のデュアルサイドバー、記事グリッド（多カラム）レイアウト、メイソンリーレイアウトを革新的に追加しています。
>
...
>
>*awacg の上記コンポーネント設計や関連コードを参考または利用する場合は、出典としてawacg を明記してください。**
>
awacg はオリジナルの fuwari レイアウトも保持しており、設定ファイルで好みに応じて自由に切り替えられます。
>
>**レイアウト設定とデモの詳細については、awacg レイアウトシステム詳解](https://awacg.cuteleaf.cn/posts/awacg-layout-system/)をご覧ください**
>
awacg は i18n の多言語 UI をサポートしていますが、簡体字中国語以外の言語は AI 翻訳です。誤りがある場合は、[Pull Request](https://github.com/CuteLeafawacg/pulls) の提出を歓迎します。
...
便利な機能や最適化があれば、[Pull Request](https://github.com/CuteLeafawacg/pulls)を提出してください
...
1. **リポジトリのクローン：**
   ```bash
   git clone https://github.com/Cuteleafawacg
.git
   cdawacg

   ```
   
   **まず自分のリポジトリに[Fork](https://github.com/CuteLeafawacg
/fork)してからクローン（推奨）。クローンする前にStarをクリックするのを忘れずに！**

   ```bash
   git clone https://github.com/you-github-nameawacg
.git
   cdawacg
...
- **Vercel**、**Netlify** などの主要プラットフォームは自動デプロイに対応し、環境に応じて適切なアダプターが自動的に選択されます。
   ...
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/CuteLeafawacg
&project-nameawacg
&repository-nameawacg
)
   [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/CuteLeafawacg
)

## 📖 設定説明

> 📚 **詳細な設定ドキュメント**：[awacgドキュメント](https://docs-awacg.cuteleaf.cn/)で完全な設定ガイドを確認してください
...
- Admonitions（予告ブロック） - GitHub、Obsidian、VitePress、Docusaurusの4つのテーマ設定をサポート ([プレビューと使用方法](https://awacg.cuteleaf.cn/posts/markdown-extended/))
- GitHubリポジトリカード ([プレビューと使用方法](https://awacg.cuteleaf.cn/posts/markdown-extended/))
- Expressive Codeベースの強化コードブロック ([プレビュー](http://awacg.cuteleaf.cn/posts/code-examples/) / [ドキュメント](https://expressive-code.com/))
...
[fuwari](https://github.com/saicaca/fuwari)テンプレートを開発した[saicaca](https://github.com/saicaca)に深く感謝します。awacgはこのテンプレートをベースに二次開発されています。
...
- Copyright (c) 2025 [CuteLeaf](https://github.com/CuteLeaf) - awacg](https://github.com/CuteLeafawacg)

MITライセンスに基づき、コードの自由な使用、変更、配布が許可されていますが、上記の著作権表示を保持する必要があります。

## 🍀 貢献者

このプロジェクトに貢献してくれた以下の貢献者に感謝します。質問や提案がある場合は、[Issue](https://github.com/CuteLeafawacg/issues)または[Pull Request](https://github.com/CuteLeafawacg/pulls)を提出してください。

><a href="https://github.com/CuteLeafawacg/graphs/contributors">
>  <img src="https://contrib.rocks/image?repo=CuteLeafawacg" />
></a>
...
[![Star History Chart](https://api.star-history.com/svg?repos=CuteLeafawacg&type=Date)](https://star-history.com/#CuteLeafawacg&Date)
