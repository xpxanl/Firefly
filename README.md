...
<img src="./docs/images/1131.png" width = "350" height = "500" alt="awacg
" align=right />
...
>
> [![Stars](https://img.shields.io/github/stars/CuteLeaf/awacg
?style=social)](https://github.com/CuteLeaf/awacg
/stargazers)
[![Forks](https://img.shields.io/github/forks/CuteLeaf/awacg
?style=social)](https://github.com/CuteLeaf/awacg
/network/members)
[![Issues](https://img.shields.io/github/issues/CuteLeaf/awacg
)](https://github.com/CuteLeaf/awacg
/issues)
> 
...
<img alt="awacg
" src="./docs/images/1.webp" />
<img alt="Lighthouse" src="./docs/images/Lighthouse.png" />

>[!TIP]
>
>awacg
 是一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。该主题融合了现代 Web 技术栈，提供了丰富的功能模块和高度可定制的界面，让您能够轻松打造出专业且美观的个人博客网站。
> 
>在重要的布局上，awacg
 创新性地增加了左右双侧边栏、文章网格(多列)布局、瀑布流布局。
>
...
>
>**如果你参考或使用了 awacg
 以上组件设计和相关代码，请注明来自 awacg
。**
>
>awacg
 也保留了原版 fuwari 的布局，可根据自己的喜好在配置文件中自由切换。
>
>**更多布局配置及演示请查看：[awacg
 布局系统详解](https://awacg
.cuteleaf.cn/posts/awacg
-layout-system/)**
>
>awacg
 支持i18n多语言UI，但除了简体中文，其他语言均为AI翻译转换，如有错误，欢迎提交 [Pull Request](https://github.com/CuteLeaf/awacg
/pulls) 修正。
...
如果你有好用的功能和优化，请提交 [Pull Request](https://github.com/CuteLeaf/awacg
/pulls)
...
1. **克隆仓库：**
   ```bash
   git clone https://github.com/Cuteleaf/awacg
   .git
   cd awacg
   
   ```
   
   **先 [Fork](https://github.com/CuteLeaf/awacg
   /fork) 到自己仓库在克隆（推荐），记得先点 Star 在 Fork 哦！**

   ```bash
   git clone https://github.com/you-github-name/awacg
   .git
   cd awacg
...
- **Vercel**、**Netlify** 等主流平台自动部署，会根据环境自动选择适配器。
   ...
   [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/CuteLeaf/awacg
   &project-name=awacg
   &repository-name=awacg
   )
...
- 提醒块（Admonitions） - 支持 GitHub, Obsidian, VitePress, Docusaurus 四种风格主题配置 ([预览和用法](https://awacg
.cuteleaf.cn/posts/markdown-extended/))
- GitHub 仓库卡片 ([预览和用法](https://awacg
.cuteleaf.cn/posts/markdown-extended/))
- 基于 Expressive Code 的增强代码块 ([预览](http://awacg
.cuteleaf.cn/posts/code-examples/) / [文档](https://expressive-code.com/))
...
非常感谢 [saicaca](https://github.com/saicaca) 开发的 [fuwari](https://github.com/saicaca/fuwari) 模板，awacg
 就是基于这个模板二次开发
...
- Copyright (c) 2025 [CuteLeaf](https://github.com/CuteLeaf) - [awacg
](https://github.com/CuteLeaf/awacg
) 
...
感谢以下贡献者对本项目做出的贡献，如有问题或建议，请提交 [Issue](https://github.com/CuteLeaf/awacg
/issues) 或 [Pull Request](https://github.com/CuteLeaf/awacg
/pulls)。

><a href="https://github.com/CuteLeaf/awacg
/graphs/contributors">
...
[![Star History Chart](https://api.star-history.com/svg?repos=CuteLeaf/awacg
&type=Date)](https://star-history.com/#CuteLeaf/awacg
&Date)
